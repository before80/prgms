...
> 原文链接: [https://docs.astral.sh/uv/reference/settings/](https://docs.astral.sh/uv/reference/settings/)

# Settings

## Project metadata {#project-metadata}

### `build-constraint-dependencies` {#build-constraint-dependencies}
...
- scripts
  : Installed to the directory for executables,
  <venv>/bin
  on Unix or
  <venv>\Scripts
  on Windows. This directory is added to
  PATH
  when the virtual environment is activated or when using
  uv run
  , so this data type can be used to install additional binaries. Consider using
  project.scripts
  instead for Python entrypoints.
...
- purelib
  ...
  : Installed to the
  site-packages
  directory. It is not recommended to use these two options.
...
#### `default-excludes` {#build-backend_default-excludes}
...
#### `module-name` {#build-backend_module-name}
...
#### `module-root` {#build-backend_module-root}
...
#### `namespace` {#build-backend_namespace}
...
#### `source-exclude` {#build-backend_source-exclude}
...
#### `source-include` {#build-backend_source-include}
...
#### `wheel-exclude` {#build-backend_wheel-exclude}
...
### `config-settings-package` {#config-settings-package}
...
- (Optional)
  version
  : The version of the package. If omitted, the metadata will be applied to all versions of the package.
- (Optional)
  requires-dist
  : The dependencies of the package (e.g.,
  werkzeug>=0.14
  ).
- (Optional)
  requires-python
  : The Python version required by the package (e.g.,
  >=3.10
  ).
- (Optional)
  provides-extra
...
Set a package to `false` to exempt it from the global `exclude-newer` constraint entirely.
...
### `extra-build-variables` {#extra-build-variables}
...
The URL of the Python package index (by default: [https://pypi.org/simple](https://pypi.org/simple)).
...
Package-specific modes take precedence over the global `prerelease` mode. Accepts a dictionary mapping package names to any supported pre-release mode.
...
The URL for publishing packages to the Python package index (by default: [https://upload.pypi.org/legacy/](https://upload.pypi.org/legacy/)).
...
### `pypy-install-mirror` {#pypy-install-mirror}
...
#### `ignore-until-fixed` {#audit_ignore-until-fixed}
...
#### `malware-check` {#audit_malware-check}
...
#### `malware-check-url` {#audit_malware-check-url}
...
#### `allow-empty-requirements` {#pip_allow-empty-requirements}
...
#### `annotation-style` {#pip_annotation-style}
...
#### `break-system-packages` {#pip_break-system-packages}
...
#### `compile-bytecode` {#pip_compile-bytecode}
...
#### `config-settings` {#pip_config-settings}
...
#### `config-settings-package` {#pip_config-settings-package}
...
#### `custom-compile-command` {#pip_custom-compile-command}
...
#### `dependency-metadata` {#pip_dependency-metadata}
...
#### `emit-build-options` {#pip_emit-build-options}
...
#### `emit-find-links` {#pip_emit-find-links}
...
#### `emit-index-annotation` {#pip_emit-index-annotation}
...
#### `emit-index-url` {#pip_emit-index-url}
...
#### `emit-marker-expression` {#pip_emit-marker-expression}
...
#### `exclude-newer` {#pip_exclude-newer}
...
#### `exclude-newer-package` {#pip_exclude-newer-package}
...
#### `extra-build-dependencies` {#pip_extra-build-dependencies}
...
#### `extra-build-variables` {#pip_extra-build-variables}
...
#### `extra-index-url` {#pip_extra-index-url}
...
#### `fork-strategy` {#pip_fork-strategy}
...
#### `generate-hashes` {#pip_generate-hashes}
...
#### `index-strategy` {#pip_index-strategy}
...
#### `keyring-provider` {#pip_keyring-provider}
...
#### `no-build-isolation` {#pip_no-build-isolation}
...
#### `no-build-isolation-package` {#pip_no-build-isolation-package}
...
#### `no-emit-package` {#pip_no-emit-package}
...
#### `no-sources-package` {#pip_no-sources-package}
...
#### `no-strip-extras` {#pip_no-strip-extras}
...
#### `no-strip-markers` {#pip_no-strip-markers}
...
#### `python-platform` {#pip_python-platform}
...
#### `python-version` {#pip_python-version}
...
#### `reinstall-package` {#pip_reinstall-package}
...
#### `require-hashes` {#pip_require-hashes}
...
#### `torch-backend` {#pip_torch-backend}
...
#### `upgrade-package` {#pip_upgrade-package}
...
#### `verify-hashes` {#pip_verify-hashes}
