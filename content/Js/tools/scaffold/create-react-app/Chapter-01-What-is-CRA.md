...
| **正式废弃** | **2025 年 2 月** | **React 官方宣布废弃，推荐迁移到框架或 Vite/Parcel/Rsbuild** |

可以看到，CRA 经历过自己的黄金时代，但 React 官方在 2025 年 2 月正式将其废弃。CRA 仍会以维护模式继续可用，但新项目不应再使用它；后面章节会详细说这个，现在先记住这个结论就好。
