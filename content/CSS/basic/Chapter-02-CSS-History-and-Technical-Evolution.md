...
### 2.2.5 PostCSS（2013 年发布，2014 年后走红）——插件化工具链，autoprefixer 是最成功的应用
...
### 2.4.5 :has() 选择器（规范 2021 定型，浏览器 2022–2023 落地）——"父选择器"
...
### 2.4.6 滚动驱动动画（2023 年起进入浏览器）——CSS 原生滚动同步动画

**滚动驱动动画**（Scroll-driven Animations）是近年 CSS 最受关注的新特性之一：Chrome 115（2023 年 7 月）率先支持，其后其他内核陆续跟进。它让你不需要 JavaScript，就能实现滚动同步的动画效果。
