...
## Freestanding Macros {#Freestanding-Macros}
...
For more information, including a full list of macro roles, see [attached](../../languagereference/3.7-Attributes/#attached) and [freestanding](../../languagereference/3.7-Attributes/#freestanding) in [Attributes](../../languagereference/3.7-Attributes/).
...
1. The compiler sends part of the in-memory representation to the macro implementation, which expands the macro.

1. The compiler replaces the macro call with its expanded form.

1. The compiler continues with compilation, using the expanded source code.
...
## Implementing a Macro {#Implementing-a-Macro}
...
## Developing and Debugging Macros {#Developing-and-Debugging-Macros}
