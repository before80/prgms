...
You can also use type casting to check whether a type conforms to a protocol, as described in [Checking for Protocol Conformance](../2.23-Protocols/#Checking-for-Protocol-Conformance).
