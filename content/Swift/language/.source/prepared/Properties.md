...
You can provide a default value for a stored property as part of its definition, as described in [Default Property Values](../2.14-Initialization/#Default-Property-Values). You can also set and modify the initial value for a stored property during initialization. This is true even for constant stored properties, as described in [Assigning Constant Properties During Initialization](../2.14-Initialization/#Assigning-Constant-Properties-During-Initialization).
...
Omitting the `return` from a getter follows the same rules as omitting `return` from a function, as described in [Functions With an Implicit Return](../2.6-Functions/#Functions-With-an-Implicit-Return).
...
> see [Initializer Delegation for Value Types](../2.14-Initialization/#Initializer-Delegation-for-Value-Types)
> and [Initializer Delegation for Class Types](../2.14-Initialization/#Initializer-Delegation-for-Class-Types).
...
> see [In-Out Parameters](../../languagereference/3.6-Declarations/#In-Out-Parameters).
...
> For information about `private`, see [Access Control](../2.28-AccessControl/).
...
The definition of `SmallNumber` includes three initializers --- `init()`, `init(wrappedValue:)`, and `init(wrappedValue:maximum:)` --- which the examples below use to set the wrapped value and the maximum value. For information about initialization and initializer syntax, see [Initialization](../2.14-Initialization/).
...
> in a similar manner to [Lazy Stored Properties](./#Lazy-Stored-Properties).
