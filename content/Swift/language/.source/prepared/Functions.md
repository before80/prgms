...
> in [Function Argument Labels and Parameter Names](./#Function-Argument-Labels-and-Parameter-Names)
> and [Default Parameter Values](./#Default-Parameter-Values).
...
As you'll see in [Shorthand Getter Declaration](../2.10-Properties/#Shorthand-Getter-Declaration), property getters can also use an implicit return.
