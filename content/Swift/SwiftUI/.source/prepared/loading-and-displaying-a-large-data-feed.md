...
### Import data in the background {#Import-data-in-the-background}
...
### Merge changes and update the user interface {#Merge-changes-and-update-the-user-interface}
...
### Work in batches to lower memory footprint {#Work-in-batches-to-lower-memory-footprint}
...
### Prevent duplicate data in the store {#Prevent-duplicate-data-in-the-store}
