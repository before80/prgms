...
![A conceptual illustration of a disclosure indicator, shown animating frame by frame from its collapsed position to its expanded position.](./images/Unifying-your-app-s-animations@2x.png)
...
### Create a SwiftUI animation {#Create-a-SwiftUI-animation}
...
### Use completion handlers with SwiftUI animations {#Use-completion-handlers-with-SwiftUI-animations}
...
### Retarget a SwiftUI animation {#Retarget-a-SwiftUI-animation}
...
### Troubleshoot animations {#Troubleshoot-animations}
