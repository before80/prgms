...
## Create a simple bounce animation {#Create-a-simple-bounce-animation}
...
视频：[A video that shows a heart-shaped emoji that moves up to its](https://developer.apple.com/tutorials/videos/com.apple.SwiftUI/phase-keyframe-animation-01.mp4)
...
## Bounce with a phase animator {#Bounce-with-a-phase-animator}
...
视频：[A video that shows a heart-shaped emoji that moves up to its](https://developer.apple.com/tutorials/videos/com.apple.SwiftUI/phase-keyframe-animation-02.mp4)
...
视频：[A video that shows a heart-shaped emoji that bounces slightl](https://developer.apple.com/tutorials/videos/com.apple.SwiftUI/phase-keyframe-animation-03.mp4)

## Add more phases to the animation {#Add-more-phases-to-the-animation}
...
视频：[A video that shows a heart-shaped emoji that moves up. As th](https://developer.apple.com/tutorials/videos/com.apple.SwiftUI/phase-keyframe-animation-04.mp4)
...
## Gain more control with a keyframe animator {#Gain-more-control-with-a-keyframe-animator}
...
> Note: [KeyframeAnimator](https://developer.apple.com/documentation/swiftui/keyframeanimator) can animate any value that conforms to the [Animatable](https://developer.apple.com/documentation/swiftui/animatable) protocol.
...
- term `content`: The view that’s animating.
- term `value`: The current interpolated values.
...
视频：[A video that shows a heart-shaped emoji that squishes and st](https://developer.apple.com/tutorials/videos/com.apple.SwiftUI/phase-keyframe-animation-05.mp4)
