...
When providing a transferable type, you should typically provide a [SharePreview](https://developer.apple.com/documentation/swiftui/sharepreview) which provides the appropriate content for rendering the preview in the header of the menu.
