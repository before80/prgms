...
### Sequence one gesture after another {#Sequence-one-gesture-after-another}

When you sequence one gesture after another, SwiftUI recognizes the first gesture before it recognizes the second. For example, to require a long press before the user can drag a view, you sequence a [DragGesture](https://developer.apple.com/documentation/swiftui/draggesture) after a [LongPressGesture](https://developer.apple.com/documentation/swiftui/longpressgesture).

#### Model sequenced gesture states {#Model-sequenced-gesture-states}
...
#### Create gestures and update the UI state {#Create-gestures-and-update-the-UI-state}
