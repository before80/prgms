...
To get started arranging views, see [Layout fundamentals](../../../viewlayout/1-LayoutFundamentals/). To make adjustments to a basic layout, see [Layout adjustments](../../../viewlayout/2-LayoutAdjustments/).
...
## Safe area and margins {#Safe-area-and-margins}
...
## Custom layout characteristics {#Custom-layout-characteristics}
