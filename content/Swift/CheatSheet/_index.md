...
| [16 血泪速查]({{< relref "16-Pitfalls-and-Gotchas.md" >}}) | 按**症状**索引的踩坑表：会怎么写 / 实际发生什么 / 正确写法 |
...
💭 已经出事了（崩溃、结果不对、编译莫名其妙不过）？别从头翻，直接去 [16 血泪速查]({{< relref "16-Pitfalls-and-Gotchas.md" >}})——那一章是按**症状**索引的，每条都写着"你会怎么写 / 实际发生什么 / 正确写法"。
