+++
title = "7.5.5 swift package-registry logout"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packageregistrylogout/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packageregistrylogout/)

# 7.5.5 swift package-registry logout
从注册表登出。
...
### 注册表配置的变化 {#Changes-to-registry-configuration}
