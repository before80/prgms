+++
title = "7.5.1 swift package-registry set"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packageregistryset/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packageregistryset/)

# 7.5.1 swift package-registry set
设置自定义注册表。
