+++
title = "7.5.2 swift package-registry unset"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packageregistryunset/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packageregistryunset/)

# 7.5.2 swift package-registry unset
移除已配置的注册表。
