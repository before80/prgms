+++
title = "7.3.16 swift package show-executables"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packageshowexecutables/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packageshowexecutables/)

# 7.3.16 swift package show-executables
列出该包中可用的可执行文件。
