+++
title = "7.3.5 swift package add-product"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packageaddproduct/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packageaddproduct/)

# 7.3.5 swift package add-product
向清单中添加一个新产品。
