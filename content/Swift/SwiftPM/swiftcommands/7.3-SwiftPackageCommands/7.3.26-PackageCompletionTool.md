+++
title = "7.3.26 swift package completion-tool"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packagecompletiontool/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packagecompletiontool/)

# 7.3.26 swift package completion-tool
用于生成 shell 补全脚本的命令。
