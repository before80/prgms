+++
title = "7.3.22 swift package reset"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packagereset/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packagereset/)

# 7.3.22 swift package reset
重置整个缓存/构建目录。
