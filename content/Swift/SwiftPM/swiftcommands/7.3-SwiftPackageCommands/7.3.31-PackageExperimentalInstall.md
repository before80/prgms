+++
title = "7.3.31 swift package experimental-install"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packageexperimentalinstall/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packageexperimentalinstall/)

# 7.3.31 swift package experimental-install
提供安装当前包的可执行产品的能力。
