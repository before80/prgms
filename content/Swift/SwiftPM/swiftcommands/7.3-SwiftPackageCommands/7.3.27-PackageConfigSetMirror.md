+++
title = "7.3.27 swift package config set-mirror"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packageconfigsetmirror/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packageconfigsetmirror/)

# 7.3.27 swift package config set-mirror
为某个依赖设置镜像。
