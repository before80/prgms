+++
title = "7.3.1 swift package init"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packageinit/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packageinit/)

# 7.3.1 swift package init
初始化一个新包。
