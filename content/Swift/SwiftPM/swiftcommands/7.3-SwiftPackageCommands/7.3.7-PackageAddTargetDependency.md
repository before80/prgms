+++
title = "7.3.7 swift package add-target-dependency"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packageaddtargetdependency/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packageaddtargetdependency/)

# 7.3.7 swift package add-target-dependency
向清单中添加一个新的目标依赖。
