+++
title = "7.3.8 swift package add-setting"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packageaddsetting/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packageaddsetting/)

# 7.3.8 swift package add-setting
向清单中添加一个新设置。
