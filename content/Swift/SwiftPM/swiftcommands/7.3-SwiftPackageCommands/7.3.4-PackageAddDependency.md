+++
title = "7.3.4 swift package add-dependency"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packageadddependency/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packageadddependency/)

# 7.3.4 swift package add-dependency
向清单中添加一个包依赖。
