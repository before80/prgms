+++
title = "7.3.6 swift package add-target"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packageaddtarget/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packageaddtarget/)

# 7.3.6 swift package add-target
向清单中添加一个新目标。
