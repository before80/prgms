+++
title = "7.6.2 swift package-collection search"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packagecollectionsearch/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packagecollectionsearch/)

# 7.6.2 swift package-collection search
按关键字或模块名搜索包。

## 概述 {#Overview}
这个子命令在已导入的集合中按关键字或模块名搜索包。结果可以选择用 `--json` 以 JSON 形式返回，便于集成到其他工具中。

### 基于字符串的搜索 {#String-based-search}
