+++
title = "7.6.6 swift package-collection remove"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packagecollectionremove/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packagecollectionremove/)

# 7.6.6 swift package-collection remove
移除已配置的集合。
