+++
title = "7.6.4 swift package-collection list"
...
> 原文链接: [https://docs.swift.org/latest/documentation/packagemanagerdocs/packagecollectionlist/](https://docs.swift.org/latest/documentation/packagemanagerdocs/packagecollectionlist/)

# 7.6.4 swift package-collection list
列出已配置的集合。
