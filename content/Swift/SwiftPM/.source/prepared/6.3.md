...
## SwiftBuild: Preview of Next-Generation Build System {#SwiftBuild-Preview-of-Next-Generation-Build-System}
...
### Trying SwiftBuild {#Trying-SwiftBuild}
...
## Improved Build Plugin Support for C Interoperability {#Improved-Build-Plugin-Support-for-C-Interoperability}
...
## Improved Prebuilt Swift Syntax for Macros Support {#Improved-Prebuilt-Swift-Syntax-for-Macros-Support}
...
## Symbol Graph Generation: Control Over Inherited Documentation {#Symbol-Graph-Generation-Control-Over-Inherited-Documentation}
...
## Package Traits: Improved Discoverability {#Package-Traits-Improved-Discoverability}
