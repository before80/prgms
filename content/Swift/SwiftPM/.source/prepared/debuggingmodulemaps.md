...
## Overview {#Overview}
When you create module maps for C libraries, compilation errors or import failures indicate problems with your configuration. This article shows you how to test module maps and fix common issues.
...
## Test your module map {#Test-your-module-map}
Verify that Swift can import your module before distributing it.

### Create a simple import test {#Create-a-simple-import-test}
...
### Fix module name mismatches {#Fix-module-name-mismatches}
...
### Locate missing headers {#Locate-missing-headers}
...
### Fix C++ compilation errors {#Fix-C++-compilation-errors}
