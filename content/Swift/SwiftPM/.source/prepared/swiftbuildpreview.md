...
## How to use the Swift Build build system {#How-to-use-the-Swift-Build-build-system}
...
## Key improvements and differences {#Key-improvements-and-differences}
...
#### Resource support parity with xcodebuild {#Resource-support-parity-with-xcodebuild}
...
#### Swift Driver integration {#Swift-Driver-integration}
