...
For more information about usage and how to publish your own package collections, see the [Package Collections documentation](../../../sharingpackages/5.2-PackageCollections/).

### Executable target testing {#Executable-target-testing}
...
### Manifest API improvements {#Manifest-API-improvements}
