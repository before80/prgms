...
> 欢迎来到第六章！这一章我们要聊的是 Go 语言的"语句"。如果说变量是名词，那语句就是动词——它告诉计算机"接下来做什么"。顺序执行、条件判断、循环往复……这些都是语句的功劳。准备好了吗？让我们开始吧！
...
func main() {
    ...
    // 上面的变量不打印的话，Go 会报 declared and not used
    fmt.Println(globalVar, x, y) // 我是一个全局变量 20 30
}
```
...
func main() {
    ...
    case 3:
        fmt.Println("星期三") // 星期三
    default:
        fmt.Println("其他") // 不会执行，day=3 已经在 case 3 命中
    }
