+++
title = "05-cargo uninstall"
date = 2026-07-30T14:49:00+08:00
weight = 76
type = "docs"
description = "cargo-uninstall(1) 卸载二进制 crate"
isCJKLanguage = true
draft = false
...
> 原文链接: [https://doc.rust-lang.org/cargo/commands/cargo-uninstall.html](https://doc.rust-lang.org/cargo/commands/cargo-uninstall.html)
...
## 描述 {#description}
此命令移除用 [cargo-install(1)](../02-cargo-install/) 安装的包。_spec_
参数是要移除的包的包 ID 规范（见
[cargo-pkgid(1)](../../manifest-commands/06-cargo-pkgid/)）。

默认会移除某个 crate 的所有二进制文件，但可用 `--bin` 与
`--example` 标志仅移除特定二进制文件。
...
<dd class="option-desc"><p>要卸载的包。</p>
</dd>
...
<dd class="option-desc"><p>仅卸载二进制文件 <em>name</em>。</p>
</dd>
...
<dd class="option-desc"><p>要从中卸载包的目录。</p>
</dd>
...
## 参见 {#see-also}
[cargo(1)](../../general-commands/01-cargo/), [cargo-install(1)](../02-cargo-install/)
