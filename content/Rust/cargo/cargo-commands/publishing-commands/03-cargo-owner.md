+++
title = "03-cargo owner"
date = 2026-07-30T14:49:00+08:00
weight = 80
type = "docs"
description = "cargo-owner(1) 管理 crate 所有者"
isCJKLanguage = true
draft = false
...
> 原文链接: [https://doc.rust-lang.org/cargo/commands/cargo-owner.html](https://doc.rust-lang.org/cargo/commands/cargo-owner.html)


## 名称 {#name}
cargo-owner --- 管理注册表上某个 crate 的所有者
...
## 描述 {#description}
此命令会修改注册表上某个 crate 的所有者。crate 的所有者可以上传新版本并 yank 旧版本。
非团队所有者还可以修改所有者集合，请谨慎操作！

此命令要求你通过 `--token` 选项或使用 [cargo-login(1)](../01-cargo-login/) 完成身份验证。

若未指定 crate 名称，将使用当前目录中的包名。

关于所有者与发布的更多信息，见[参考文档](../../../cargo-guide/09-publishing-on-crates-io/#cargo-owner)。
...
<dd class="option-desc"><p>移除给定用户或团队作为所有者。</p>
</dd>
