+++
title = "04-cargo clean"
date = 2026-07-30T14:49:00+08:00
weight = 49
type = "docs"
description = "cargo-clean(1) 清理目标文件"
isCJKLanguage = true
draft = false
...
> 原文链接: [https://doc.rust-lang.org/cargo/commands/cargo-clean.html](https://doc.rust-lang.org/cargo/commands/cargo-clean.html)


## 名称 {#name}
cargo-clean --- 移除已生成的产物

## 大纲 {#synopsis}
`cargo clean` [_options_]

## 描述 {#description}
移除 target 目录中 Cargo 过去生成的产物。

若不带任何选项，`cargo clean` 将删除整个 target 目录。

## 选项 {#options}
### 包选择 {#package-selection}
未选择任何包时，将清理工作空间中的所有包及其所有依赖。
...
<dd class="option-desc"><p>仅清理指定的包。此标志可指定多次。SPEC 格式见 <a href="../manifest-commands/06-cargo-pkgid.md">cargo-pkgid(1)</a>。</p>
</dd>
...
<dd class="option-desc"><p>清理工作空间成员的产物。</p>
</dd>


</dl>

### Clean 选项 {#clean-options}
<dl>
...
<dd class="option-desc"><p>显示将要删除内容的摘要，但不实际删除。
与 <code>--verbose</code> 一起使用可显示将被删除的实际文件。</p>
</dd>


<dt class="option-term" id="option-cargo-clean---doc"><a class="option-anchor" href="#option-cargo-clean---doc"><code>--doc</code></a></dt>
<dd class="option-desc"><p>此选项使 <code>cargo clean</code> 仅移除 target 目录中的 <code>doc</code> 目录。</p>
</dd>
...
<dd class="option-desc"><p>移除 <code>release</code> 目录中的所有产物。</p>
</dd>
...
<dd class="option-desc"><p>移除具有给定配置文件名称的目录中的所有产物。</p>
</dd>
...
<dd class="option-desc"><p>为指定的目标架构清理。此标志可指定多次。默认为主机架构。triple 的一般格式为
