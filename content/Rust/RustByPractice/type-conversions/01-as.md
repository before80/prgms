...
weight = 36
type = "docs"
description = "as — Rust By Practice"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://practice-rust-zh.beatai.org/type-conversions/as.html](https://practice-rust-zh.beatai.org/type-conversions/as.html)
