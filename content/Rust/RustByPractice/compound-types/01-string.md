...
weight = 14
type = "docs"
description = "字符串 — Rust By Practice"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://practice-rust-zh.beatai.org/compound-types/string.html](https://practice-rust-zh.beatai.org/compound-types/string.html)
