...
weight = 56
type = "docs"
description = "闭包 Closure — Rust By Practice"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://practice-rust-zh.beatai.org/functional-programing/closure.html](https://practice-rust-zh.beatai.org/functional-programing/closure.html)
