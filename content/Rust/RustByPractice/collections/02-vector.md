...
weight = 33
type = "docs"
description = "动态数组 Vector — Rust By Practice"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://practice-rust-zh.beatai.org/collections/vector.html](https://practice-rust-zh.beatai.org/collections/vector.html)
