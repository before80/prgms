...
weight = 3
type = "docs"
description = "值得学习的小型项目 — Rust By Practice"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://practice-rust-zh.beatai.org/elegant-code-base.html](https://practice-rust-zh.beatai.org/elegant-code-base.html)
