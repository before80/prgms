...
weight = 47
type = "docs"
description = "格式化输出 — Rust By Practice"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://practice-rust-zh.beatai.org/formatted-output/intro.html](https://practice-rust-zh.beatai.org/formatted-output/intro.html)
