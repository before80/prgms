+++
title = "01-死代码 `dead_code`"
date = 2026-08-20T21:20:00+08:00
weight = 83
type = "docs"
description = "死代码 `dead_code` — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/attribute/unused.html](https://doc.rust-lang.org/stable/rust-by-example/attribute/unused.html)
