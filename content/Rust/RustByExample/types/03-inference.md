...
weight = 29
type = "docs"
description = "类型推断 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/types/inference.html](https://doc.rust-lang.org/stable/rust-by-example/types/inference.html)
