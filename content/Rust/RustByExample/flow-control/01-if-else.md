...
weight = 37
type = "docs"
description = "if/else — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/flow_control/if_else.html](https://doc.rust-lang.org/stable/rust-by-example/flow_control/if_else.html)
