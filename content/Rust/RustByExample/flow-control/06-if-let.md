...
weight = 52
type = "docs"
description = "if let — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/flow_control/if_let.html](https://doc.rust-lang.org/stable/rust-by-example/flow_control/if_let.html)
