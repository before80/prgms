...
weight = 106
type = "docs"
description = "借用 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/scope/borrow.html](https://doc.rust-lang.org/stable/rust-by-example/scope/borrow.html)
