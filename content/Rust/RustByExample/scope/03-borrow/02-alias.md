...
weight = 108
type = "docs"
description = "别名使用 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/scope/borrow/alias.html](https://doc.rust-lang.org/stable/rust-by-example/scope/borrow/alias.html)
