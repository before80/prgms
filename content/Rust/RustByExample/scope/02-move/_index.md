...
weight = 103
type = "docs"
description = "所有权和移动 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/scope/move.html](https://doc.rust-lang.org/stable/rust-by-example/scope/move.html)
...
```
[references]: ../../flow-control/05-match/01-destructuring/04-destructure-pointers/