...
weight = 100
type = "docs"
description = "测试实例：单位检查 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/generics/phantom/testcase_units.html](https://doc.rust-lang.org/stable/rust-by-example/generics/phantom/testcase_units.html)
...
[Borrowing (`&`)]: ../../scope/03-borrow/
[Bounds (`X: Y`)]: ../04-bounds/
[enum]: ../../custom-types/02-enum/
[impl & self]: ../../fn/01-methods/
[Overloading]: ../../trait/03-ops/
[ref]: ../../scope/03-borrow/03-ref/
[Traits (`X for Y`)]: ../../trait/
[TupleStructs]: ../../custom-types/01-structs/
