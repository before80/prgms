...
weight = 175
type = "docs"
description = "路径 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/std_misc/path.html](https://doc.rust-lang.org/stable/rust-by-example/std_misc/path.html)
