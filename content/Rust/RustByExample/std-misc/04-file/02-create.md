+++
title = "02-创建文件 `create`"
date = 2026-08-20T21:20:00+08:00
weight = 178
type = "docs"
description = "创建文件 `create` — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/std_misc/file/create.html](https://doc.rust-lang.org/stable/rust-by-example/std_misc/file/create.html)
