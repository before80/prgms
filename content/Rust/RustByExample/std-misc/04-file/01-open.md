...
weight = 177
type = "docs"
description = "打开文件 `open` — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/std_misc/file/open.html](https://doc.rust-lang.org/stable/rust-by-example/std_misc/file/open.html)
