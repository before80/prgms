+++
title = "03-读取行 `read lines`"
date = 2026-08-20T21:20:00+08:00
weight = 179
type = "docs"
description = "读取行 `read lines` — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/std_misc/file/read_lines.html](https://doc.rust-lang.org/stable/rust-by-example/std_misc/file/read_lines.html)
