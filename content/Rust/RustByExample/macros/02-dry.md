...
weight = 135
type = "docs"
description = "DRY (不写重复代码) — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/macros/dry.html](https://doc.rust-lang.org/stable/rust-by-example/macros/dry.html)
