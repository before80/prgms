+++
title = "第17章 使用 `macro_rules!` 来创建宏"
date = 2026-08-20T21:20:00+08:00
weight = 130
type = "docs"
description = "使用 `macro_rules!` 来创建宏 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/macros.html](https://doc.rust-lang.org/stable/rust-by-example/macros.html)
