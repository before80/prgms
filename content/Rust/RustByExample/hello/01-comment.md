...
weight = 4
type = "docs"
description = "注释 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/hello/comment.html](https://doc.rust-lang.org/stable/rust-by-example/hello/comment.html)
