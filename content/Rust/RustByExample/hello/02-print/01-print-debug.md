...
weight = 6
type = "docs"
description = "调试（debug） — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/hello/print/print_debug.html](https://doc.rust-lang.org/stable/rust-by-example/hello/print/print_debug.html)
