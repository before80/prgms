...
weight = 7
type = "docs"
description = "显示（display） — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/hello/print/print_display.html](https://doc.rust-lang.org/stable/rust-by-example/hello/print/print_display.html)
