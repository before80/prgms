...
weight = 9
type = "docs"
description = "格式化 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/hello/print/fmt.html](https://doc.rust-lang.org/stable/rust-by-example/hello/print/fmt.html)
