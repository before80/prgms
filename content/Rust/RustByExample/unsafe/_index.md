...
weight = 192
type = "docs"
description = "不安全操作 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/unsafe.html](https://doc.rust-lang.org/stable/rust-by-example/unsafe.html)
...
* 解引用裸指针
* 通过 FFI 调用函数（这已经在[之前的章节](../std-misc/08-ffi/)介绍过了）
* 调用不安全的函数
