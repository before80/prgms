...
weight = 23
type = "docs"
description = "作用域和遮蔽 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/variable_bindings/scope.html](https://doc.rust-lang.org/stable/rust-by-example/variable_bindings/scope.html)
