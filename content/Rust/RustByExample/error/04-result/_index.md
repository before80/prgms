...
weight = 146
type = "docs"
description = "结果 `Result` — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/error/result.html](https://doc.rust-lang.org/stable/rust-by-example/error/result.html)
...
[the following section]: 03-early-returns/