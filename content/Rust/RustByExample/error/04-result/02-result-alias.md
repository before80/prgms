+++
title = "02-给 `Result` 取别名"
date = 2026-08-20T21:20:00+08:00
weight = 148
type = "docs"
description = "给 `Result` 取别名 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/error/result/result_alias.html](https://doc.rust-lang.org/stable/rust-by-example/error/result/result_alias.html)
