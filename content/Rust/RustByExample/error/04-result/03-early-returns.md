...
weight = 149
type = "docs"
description = "提前返回 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/error/result/early_returns.html](https://doc.rust-lang.org/stable/rust-by-example/error/result/early_returns.html)
