...
weight = 150
type = "docs"
description = "引入 `?` — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/error/result/enter_question_mark.html](https://doc.rust-lang.org/stable/rust-by-example/error/result/enter_question_mark.html)
...
[re_enter_?]: ../05-multiple-error-types/04-reenter-question-mark/