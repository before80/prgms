+++
title = "01-`Result` 的 `map`"
date = 2026-08-20T21:20:00+08:00
weight = 147
type = "docs"
description = "`Result` 的 `map` — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/error/result/result_map.html](https://doc.rust-lang.org/stable/rust-by-example/error/result/result_map.html)
