+++
title = "03-`Option` 和 `unwrap`"
date = 2026-08-20T21:20:00+08:00
weight = 141
type = "docs"
description = "`Option` 和 `unwrap` — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/error/option_unwrap.html](https://doc.rust-lang.org/stable/rust-by-example/error/option_unwrap.html)
