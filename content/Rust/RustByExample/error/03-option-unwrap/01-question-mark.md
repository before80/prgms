+++
title = "01-使用 `?` 解开 `Option`"
date = 2026-08-20T21:20:00+08:00
weight = 142
type = "docs"
description = "使用 `?` 解开 `Option` — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/error/option_unwrap/question_mark.html](https://doc.rust-lang.org/stable/rust-by-example/error/option_unwrap/question_mark.html)
