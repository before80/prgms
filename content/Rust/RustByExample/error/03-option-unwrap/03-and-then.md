+++
title = "03-组合算子：`and_then`"
date = 2026-08-20T21:20:00+08:00
weight = 144
type = "docs"
description = "组合算子：`and_then` — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/error/option_unwrap/and_then.html](https://doc.rust-lang.org/stable/rust-by-example/error/option_unwrap/and_then.html)
