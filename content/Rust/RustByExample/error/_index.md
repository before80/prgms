...
weight = 138
type = "docs"
description = "错误处理 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/error.html](https://doc.rust-lang.org/stable/rust-by-example/error.html)
