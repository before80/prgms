...
weight = 153
type = "docs"
description = "定义一种错误类型 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/error/multiple_error_types/define_error_type.html](https://doc.rust-lang.org/stable/rust-by-example/error/multiple_error_types/define_error_type.html)
