...
weight = 151
type = "docs"
description = "处理多种错误类型 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/error/multiple_error_types.html](https://doc.rust-lang.org/stable/rust-by-example/error/multiple_error_types.html)
