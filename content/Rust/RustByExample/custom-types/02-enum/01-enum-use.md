...
weight = 17
type = "docs"
description = "使用 use — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/custom_types/enum/enum_use.html](https://doc.rust-lang.org/stable/rust-by-example/custom_types/enum/enum_use.html)
