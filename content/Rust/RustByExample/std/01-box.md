...
weight = 159
type = "docs"
description = "箱子、栈和堆 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/std/box.html](https://doc.rust-lang.org/stable/rust-by-example/std/box.html)
