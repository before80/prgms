...
weight = 162
type = "docs"
description = "选项 `Option` — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/std/option.html](https://doc.rust-lang.org/stable/rust-by-example/std/option.html)
