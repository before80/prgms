+++
title = "01-更改或自定义关键字类型"
date = 2026-08-20T21:20:00+08:00
weight = 167
type = "docs"
description = "更改或自定义关键字类型 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/std/hash/alt_key_types.html](https://doc.rust-lang.org/stable/rust-by-example/std/hash/alt_key_types.html)
