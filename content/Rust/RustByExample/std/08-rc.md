...
weight = 169
type = "docs"
description = "引用计数 Rc — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/std/rc.html](https://doc.rust-lang.org/stable/rust-by-example/std/rc.html)
