...
weight = 11
type = "docs"
description = "字面量和运算符 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/primitives/literals.html](https://doc.rust-lang.org/stable/rust-by-example/primitives/literals.html)
