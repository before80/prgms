+++
title = "04-`super` 和 `self`"
date = 2026-08-20T21:20:00+08:00
weight = 72
type = "docs"
description = "`super` 和 `self` — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/mod/super.html](https://doc.rust-lang.org/stable/rust-by-example/mod/super.html)
