...
weight = 73
type = "docs"
description = "文件分层 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/mod/split.html](https://doc.rust-lang.org/stable/rust-by-example/mod/split.html)
