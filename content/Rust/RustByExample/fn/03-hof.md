...
weight = 66
type = "docs"
description = "高阶函数 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/fn/hof.html](https://doc.rust-lang.org/stable/rust-by-example/fn/hof.html)
