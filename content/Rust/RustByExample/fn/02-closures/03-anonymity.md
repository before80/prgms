...
weight = 60
type = "docs"
description = "类型匿名 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/fn/closures/anonymity.html](https://doc.rust-lang.org/stable/rust-by-example/fn/closures/anonymity.html)
