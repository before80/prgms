...
weight = 59
type = "docs"
description = "作为输入参数 — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/fn/closures/input_parameters.html](https://doc.rust-lang.org/stable/rust-by-example/fn/closures/input_parameters.html)
