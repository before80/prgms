...
weight = 124
type = "docs"
description = "Drop — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/trait/drop.html](https://doc.rust-lang.org/stable/rust-by-example/trait/drop.html)
