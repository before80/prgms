...
weight = 126
type = "docs"
description = "`impl Trait` — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/trait/impl_trait.html](https://doc.rust-lang.org/stable/rust-by-example/trait/impl_trait.html)
