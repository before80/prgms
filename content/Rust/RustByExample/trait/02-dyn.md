+++
title = "02-使用 `dyn` 返回 trait"
date = 2026-08-20T21:20:00+08:00
weight = 122
type = "docs"
description = "使用 `dyn` 返回 trait — Rust By Example"
isCJKLanguage = true
draft = false
+++
...
> 原文链接: [https://doc.rust-lang.org/stable/rust-by-example/trait/dyn.html](https://doc.rust-lang.org/stable/rust-by-example/trait/dyn.html)
